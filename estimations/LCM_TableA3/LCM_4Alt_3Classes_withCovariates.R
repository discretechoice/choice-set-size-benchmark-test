...
################################################
# 
# The script: LCM ESTIMATES WITH 4 ALTERNATIVES
# 
################################################
...
# Model name                                  : LC_4Alt_3classes_with_covariates
# Model description                           : Simple LC model, no covariates in class allocation model; The effect of number of alternatives
# Model run at                                : 2025-03-29 14:10:01.658506
# Estimation method                           : bgw
# Model diagnosis                             : Relative function convergence
# Optimisation diagnosis                      : Maximum found
# hessian properties                     : Negative definite
# maximum eigenvalue                     : -0.506985
# reciprocal of condition number         : 7.88426e-08
...
# 
# LL(start)                                   : -3635.93
# LL (whole model) at equal shares, LL(0)     : -3382.56
# LL (whole model) at observed shares, LL(C)  : -3277.88
# LL(final, whole model)                      : -2386.35
# Rho-squared vs equal shares                  :  0.2945 
# Adj.Rho-squared vs equal shares              :  0.283 
# Rho-squared vs observed shares               :  0.272 
# Adj.Rho-squared vs observed shares           :  0.2628 
# AIC                                         :  4850.7 
# BIC                                         :  5076.89 
# 
# LL(0,Class_1)                    : -3382.56
# LL(final,Class_1)                : -8715.76
# LL(0,Class_2)                    : -3382.56
# LL(final,Class_2)                : -3652.08
# LL(0,Class_3)                    : -3382.56
# LL(final,Class_3)                : -4011.9
# 
# Estimated parameters                        : 39
# Time taken (hh:mm:ss)                       :  00:00:19.85 
# pre-estimation                         :  00:00:1.74 
# estimation                             :  00:00:4.47 
# post-estimation                        :  00:00:13.64 
# Iterations                                  :  66  
# 
...
# asc_1_a           4.992886    1.259446     3.96435    1.471436       3.39321
# asc_1_b          -1.257548    0.304202    -4.13392    0.391696      -3.21052
# asc_1_c          -0.465219    0.265225    -1.75406    0.299075      -1.55553
# asc_2_a           0.843043    0.610279     1.38141    0.611030       1.37971
# asc_2_b           0.152924    0.074588     2.05024    0.076916       1.98819
# asc_2_c           0.198344    0.147791     1.34206    0.147075       1.34859
# asc_3_a          -0.315028    0.752806    -0.41847    0.594902      -0.52955
# asc_3_b           0.315919    0.072683     4.34655    0.092354       3.42072
# asc_3_c           0.437774    0.155095     2.82262    0.171555       2.55180
# b_clar_a         -0.164351    0.247517    -0.66400    0.279909      -0.58716
# b_clar_b          0.207243    0.028315     7.31926    0.031110       6.66169
# b_clar_c          0.283830    0.066198     4.28759    0.093532       3.03458
# b_fish_a          1.609651    0.663231     2.42698    0.513591       3.13411
# b_fish_b          0.551961    0.065311     8.45129    0.083670       6.59685
# b_fish_c          0.326693    0.121699     2.68444    0.136933       2.38578
# b_bio_a           0.410464    0.270398     1.51800    0.359922       1.14042
# b_bio_b           0.421621    0.029205    14.43666    0.040660      10.36937
# b_bio_c           0.356789    0.066586     5.35835    0.098046       3.63899
# b_coast_a        -0.906456    0.586296    -1.54607    0.575889      -1.57401
# b_coast_b         0.078560    0.062893     1.24911    0.064611       1.21590
# b_coast_c         0.007374    0.121635     0.06062    0.152997       0.04820
# b_lit_a           0.095969    0.240377     0.39924    0.337429       0.28441
# b_lit_b           0.445454    0.030398    14.65388    0.047163       9.44496
# b_lit_c           0.418908    0.067265     6.22775    0.108663       3.85510
# b_cost_a         -0.003385    0.003330    -1.01636    0.004895      -0.69143
# b_cost_b         -0.001793  5.0749e-04    -3.53268  7.2704e-04      -2.46590
# b_cost_c         -0.018502    0.002204    -8.39562    0.004418      -4.18734
# delta_a          -0.341799    0.998612    -0.34227    1.018252      -0.33567
# delta_b           0.830495    0.734820     1.13020    0.979071       0.84825
# delta_c           0.000000          NA          NA          NA            NA
# gamma_age_a       0.010707    0.018357     0.58329    0.018276       0.58586
# gamma_age_b    -3.0179e-04    0.012704    -0.02376    0.016041      -0.01881
# gamma_age_c       0.000000          NA          NA          NA            NA
# gamma_female_a   -1.327360    0.536941    -2.47208    0.660254      -2.01038
# gamma_female_b    0.036895    0.297098     0.12418    0.315475       0.11695
# gamma_female_c    0.000000          NA          NA          NA            NA
# gamma_educ2_a    -0.975321    0.643525    -1.51559    0.715157      -1.36379
# gamma_educ2_b     0.139075    0.471417     0.29501    0.500116       0.27808
# gamma_educ2_c     0.000000          NA          NA          NA            NA
# gamma_educ3_a     0.168409    0.705520     0.23870    0.718144       0.23451
# gamma_educ3_b     0.591132    0.564288     1.04757    0.624137       0.94712
# gamma_educ3_c     0.000000          NA          NA          NA            NA
# gamma_educ4_a    -0.924631    0.663677    -1.39319    0.662202      -1.39630
# gamma_educ4_b    -0.148905    0.492391    -0.30241    0.501600      -0.29686
