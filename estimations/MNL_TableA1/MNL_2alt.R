...
################################################
# 
# The script: MNL ESTIMATES WITH 2 ALTERNATIVES
# 
################################################
...
### Set core controls
apollo_control = list(
  modelName       = "MNL_treatment_2alt",
  modelDescr      = "MNL model; The effect of number of alternatives",
  indivID         = "id",  
  # mixing          = TRUE,
  nCores          = 4,
  outputDirectory = "output.MNL.2alt"
)
...
# Model name                                  : MNL_treatment_2alt
# Model description                           : MNL model; The effect of number of alternatives
# Model run at                                : 2026-02-04 14:09:55.361417
# Estimation method                           : bgw
# Model diagnosis                             : Relative function convergence
# Optimisation diagnosis                      : Maximum found
# hessian properties                     : Negative definite
# maximum eigenvalue                     : -45.959357
# reciprocal of condition number         : 3.34167e-06
...
# LL(final)                                   : -1539.49
# Rho-squared vs equal shares                  :  0.0897 
# Adj.Rho-squared vs equal shares              :  0.0856 
# Rho-squared vs observed shares               :  0.0837 
# Adj.Rho-squared vs observed shares           :  0.0801 
# AIC                                         :  3092.98 
# BIC                                         :  3133.58 
# 
...
# b_asc1     0.776581     0.13406       5.793     0.13302         5.838
# b_clar     0.297951     0.03914       7.612     0.03466         8.596
# b_fish     0.498575     0.08692       5.736     0.09686         5.147
# b_bio      0.267840     0.03971       6.745     0.03603         7.433
# b_coast    0.187876     0.08734       2.151     0.06402         2.935
# b_lit      0.425977     0.04066      10.477     0.04133        10.307
# b_cost    -0.006938  5.1326e-04     -13.518  6.3462e-04       -10.933
