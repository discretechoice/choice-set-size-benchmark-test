...
####################################################################
#####
#####            MNL - 5 alternatives - treatment 4
#####
####################################################################
####################################################################
...
################################################
# 
# The script: MNL ESTIMATES WITH 5 ALTERNATIVES
# 
################################################
...
### Set core controls
apollo_control = list(
  modelName       = "MNL_treatment_5alt",
  modelDescr      = "MNL model; The effect of number of alternatives",
  indivID         = "id",  
  # mixing          = TRUE,
  nCores          = 4,
  outputDirectory = "output.MNL5alt"
)
...
# Model name                                  : MNL_treatment_5alt
# Model description                           : MNL model; The effect of number of alternatives
# Model run at                                : 2026-02-04 16:12:21.554703
# Estimation method                           : bgw
# Model diagnosis                             : Relative function convergence
# Optimisation diagnosis                      : Maximum found
# hessian properties                     : Negative definite
# maximum eigenvalue                     : -62.119016
# reciprocal of condition number         : 3.22516e-06
...
# LL(final)                                   : -3500.19
# Rho-squared vs equal shares                  :  0.1058 
# Adj.Rho-squared vs equal shares              :  0.1032 
# Rho-squared vs observed shares               :  0.097 
# Adj.Rho-squared vs observed shares           :  0.0955 
# AIC                                         :  7020.38 
# BIC                                         :  7078.34 
# 
# Estimated parameters                        : 10
# Time taken (hh:mm:ss)                       :  00:00:14.23 
# pre-estimation                         :  00:00:11.71 
# estimation                             :  00:00:0.39 
# post-estimation                        :  00:00:2.13 
# Iterations                                  :  7  
# 
...
# b_asc1     1.364812     0.10928      12.490     0.18445         7.399
# b_asc2     0.205472     0.06878       2.988     0.07872         2.610
# b_asc3     0.295396     0.06769       4.364     0.07139         4.138
# b_asc4     0.276803     0.06733       4.111     0.06926         3.997
# b_clar     0.213528     0.02064      10.346     0.02354         9.071
# b_fish     0.378671     0.04872       7.772     0.05044         7.507
# b_bio      0.398921     0.02112      18.888     0.02529        15.775
# b_coast    0.138259     0.04786       2.889     0.04882         2.832
# b_lit      0.462349     0.02070      22.339     0.02802        16.503
# b_cost    -0.003660  3.1771e-04     -11.518  4.9881e-04        -7.337
