...
####################################################################
#####
#####            LCM with socio-dem - 3 CLASSES - 4 alternatives - treatment 3
...
for (ite in 1:NumIter){
       ...
       for (n in 1:(n.individuals*n.choices)) {
           if(Data.ite$Clase[n] == 1){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl1[n], Data.ite$utility2.cl1[n], Data.ite$utility3.cl1[n], Data.ite$utility4.cl1[n]))
           }
           if(Data.ite$Clase[n] == 2){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl2[n], Data.ite$utility2.cl2[n], Data.ite$utility3.cl2[n], Data.ite$utility4.cl2[n]))
           }
           if(Data.ite$Clase[n] == 3){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl3[n], Data.ite$utility2.cl3[n], Data.ite$utility3.cl3[n], Data.ite$utility4.cl3[n]))
           }
       }
...
write.table(Results, file="./Results_LCM_IC99_4Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
