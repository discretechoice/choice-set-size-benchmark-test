...
####################################################################
#####
#####            LCM with socio-dem - 3 CLASSES - 5 alternatives - treatment 4
...
for (ite in 1:NumIter){
       ...
       for (n in 1:(n.individuals*n.choices)) {
           if(Data.ite$Clase[n] == 1){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl1[n], Data.ite$utility2.cl1[n], Data.ite$utility3.cl1[n], Data.ite$utility4.cl1[n], Data.ite$utility5.cl1[n]))
           }
           if(Data.ite$Clase[n] == 2){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl2[n], Data.ite$utility2.cl2[n], Data.ite$utility3.cl2[n], Data.ite$utility4.cl2[n], Data.ite$utility5.cl2[n]))
           }
           if(Data.ite$Clase[n] == 3){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl3[n], Data.ite$utility2.cl3[n], Data.ite$utility3.cl3[n], Data.ite$utility4.cl3[n], Data.ite$utility5.cl3[n]))
           }
       }
                                  ...
                                  ifelse(Data.ite$choice == 2, Data.ite$clar2,
                                         ifelse(Data.ite$choice == 3, Data.ite$clar3,
                                                ifelse(Data.ite$choice == 4, Data.ite$clar4,
                                                       ifelse(Data.ite$choice == 5, Data.ite$clar5, NA)))))
                                  ...
                                  ifelse(Data.ite$choice == 2, Data.ite$fish2,
                                         ifelse(Data.ite$choice == 3, Data.ite$fish3,
                                                ifelse(Data.ite$choice == 4, Data.ite$fish4,
                                                       ifelse(Data.ite$choice == 5, Data.ite$fish5, NA)))))
                                  ...
                                  ifelse(Data.ite$choice == 2, Data.ite$bio2,
                                         ifelse(Data.ite$choice == 3, Data.ite$bio3,
                                                ifelse(Data.ite$choice == 4, Data.ite$bio4,
                                                       ifelse(Data.ite$choice == 5, Data.ite$bio5, NA)))))
                                  ...
                                  ifelse(Data.ite$choice == 2, Data.ite$coast2,
                                         ifelse(Data.ite$choice == 3, Data.ite$coast3,
                                                ifelse(Data.ite$choice == 4, Data.ite$coast4,
                                                       ifelse(Data.ite$choice == 5, Data.ite$coast5, NA)))))
                                  ...
                                  ifelse(Data.ite$choice == 2, Data.ite$lit2,
                                         ifelse(Data.ite$choice == 3, Data.ite$lit3,
                                                ifelse(Data.ite$choice == 4, Data.ite$lit4,
                                                       ifelse(Data.ite$choice == 5, Data.ite$lit5, NA)))))
                                  ...
                                  ifelse(Data.ite$choice == 2, Data.ite$cost2,
                                         ifelse(Data.ite$choice == 3, Data.ite$cost3,
                                                ifelse(Data.ite$choice == 4, Data.ite$cost4,
                                                       ifelse(Data.ite$choice == 5, Data.ite$cost5, NA)))))
...
write.table(Results, file="./Results_LCM_IC99_5Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
