...
####################################################################
#####
#####            LCM with socio-dem - 3 CLASSES - 2 alternatives - treatment 1
...
for (ite in 1:NumIter){
       ...
       for (n in 1:(n.individuals*n.choices)) {
           if(Data.ite$Clase[n] == 1){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl1[n], Data.ite$utility2.cl1[n]))
           }
           if(Data.ite$Clase[n] == 2){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl2[n], Data.ite$utility2.cl2[n]))
           }
           if(Data.ite$Clase[n] == 3){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl3[n], Data.ite$utility2.cl3[n]))
           }
       }
  
       
       Data.ite$ch.clar <- ifelse(Data.ite$choice == 1, Data.ite$clar1,
                                         ifelse(Data.ite$choice == 2, Data.ite$clar2, NA))
       
       Data.ite$ch.fish <- ifelse(Data.ite$choice == 1, Data.ite$fish1,
                                  ifelse(Data.ite$choice == 2, Data.ite$fish2, NA))
       Data.ite$ch.bio  <- ifelse(Data.ite$choice == 1, Data.ite$bio1,
                                  ifelse(Data.ite$choice == 2, Data.ite$bio2, NA))
       Data.ite$ch.coast<- ifelse(Data.ite$choice == 1, Data.ite$coast1,
                                  ifelse(Data.ite$choice == 2, Data.ite$coast2, NA))
       Data.ite$ch.lit  <- ifelse(Data.ite$choice == 1, Data.ite$lit1,
                                  ifelse(Data.ite$choice == 2, Data.ite$lit2, NA))
       Data.ite$ch.cost <- ifelse(Data.ite$choice == 1, Data.ite$cost1,
                                  ifelse(Data.ite$choice == 2, Data.ite$cost2, NA))
       ...
       # If the individuals chooses the alternative with the highest cost value different to cero, "Yes_max_cost_NoCero" takes value 1 and 0 otherwise
...
write.table(Results, file="./Results_LCM_IC99_2Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
