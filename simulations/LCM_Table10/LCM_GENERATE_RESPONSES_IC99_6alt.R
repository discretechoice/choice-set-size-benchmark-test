...
####################################################################
#####
#####            LCM with socio-dem - 3 CLASSES - 6 alternatives - treatment 5
...
delta_b          <-  0.118786 
delta_c          <-  0.000000 
gamma_age_a      <-  0.023776 
gamma_age_b      <-  0.008047 
gamma_age_c      <-  0.000000 
gamma_female_a   <- -0.566265 
gamma_female_b   <-  0.145049 
gamma_female_c   <-  0.000000 
gamma_educ2_a    <- -0.718352 
gamma_educ2_b    <- -0.758878 
gamma_educ2_c    <-  0.000000 
gamma_educ3_a    <- -1.173361 
gamma_educ3_b    <- -0.905496 
gamma_educ3_c    <-  0.000000 
gamma_educ4_a    <- -1.100172 
gamma_educ4_b    <- -0.384078 
gamma_educ4_c    <-  0.000000 
...
Data$laten.cl.a <- delta_a + gamma_age_a * Data$age + gamma_female_a * Data$female + gamma_educ2_a * Data$educ2 + gamma_educ3_a * Data$educ3 + gamma_educ4_a * Data$educ4
Data$laten.cl.b <- delta_b + gamma_age_b * Data$age + gamma_female_b * Data$female + gamma_educ2_b * Data$educ2 + gamma_educ3_b * Data$educ3 + gamma_educ4_b * Data$educ4
Data$laten.cl.c <- delta_c + gamma_age_c * Data$age + gamma_female_c * Data$female + gamma_educ2_c * Data$educ2 + gamma_educ3_c * Data$educ3 + gamma_educ4_c * Data$educ4

Data$alloc.pr.cl.a <- exp(Data$laten.cl.a) / (exp(Data$laten.cl.a)+exp(Data$laten.cl.b)+exp(Data$laten.cl.c))
Data$alloc.pr.cl.b <- exp(Data$laten.cl.b) / (exp(Data$laten.cl.a)+exp(Data$laten.cl.b)+exp(Data$laten.cl.c))
Data$alloc.pr.cl.c <- exp(Data$laten.cl.c) / (exp(Data$laten.cl.a)+exp(Data$laten.cl.b)+exp(Data$laten.cl.c))
...
for (ite in 1:NumIter){
       ...
       ######
       # ASSIGN A CLASS TO EACH INDIVIDUAL
       ######
       
       ids <- unique(Data.ite$id)
       
       # Initialize vector to save the classes of each individual
       clases <- numeric(length(ids))
       
       # Assign a class to each individual depending on his probabilities
       for (j in seq_along(ids)) {
         id <- ids[j]
         
         # Filter the first row of the individiual
         fila <- which(Data$id == id)[1]
         
         # Ontain the probabilities
         probs <- c(Data$alloc.pr.cl.a[fila], Data$alloc.pr.cl.b[fila], Data$alloc.pr.cl.c[fila])
         
         # Randomly assign a class
         clases[j] <- sample(1:n.classes, size = 1, prob = probs)
       }
       
       # Create a vector with the class, repeated (5 times per each individual)
       clase_por_fila <- rep(clases, each = n.choices)
       
       # Add to the data.frame as a new column
       Data.ite$Clase <- clase_por_fila
       ...
       Data.ite$utility1.cl1 <- (                                       # Creating utility 1 
                                       asc_1_a
                                     + b_clar_a   * Data.ite$clar1 
                                     + b_fish_a   * Data.ite$fish1
                                     + b_bio_a    * Data.ite$bio1
                                     + b_coast_a  * Data.ite$coast1
                                     + b_lit_a    * Data.ite$lit1
                                     + b_cost_a   * Data.ite$cost1
                                     +               Data.ite$error1
                                    )
       
       
       
       Data.ite$utility2.cl1 <- (                                       # Creating utility 2 
                                      # We assume asc = 0 for all the alternatives different from the SQ 
                                       b_clar_a  * Data.ite$clar2 
                                     + b_fish_a  * Data.ite$fish2
                                     + b_bio_a   * Data.ite$bio2
                                     + b_coast_a * Data.ite$coast2
                                     + b_lit_a   * Data.ite$lit2
                                     + b_cost_a  * Data.ite$cost2
                                     +              Data.ite$error2
                                )
       
       
       Data.ite$utility3.cl1 <- (                                       # Creating utility 3  
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_a  * Data.ite$clar3 
                              + b_fish_a  * Data.ite$fish3
                              + b_bio_a   * Data.ite$bio3
                              + b_coast_a * Data.ite$coast3
                              + b_lit_a   * Data.ite$lit3
                              + b_cost_a  * Data.ite$cost3
                              +              Data.ite$error3
       )
       
       
       Data.ite$utility4.cl1 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_a  * Data.ite$clar4 
                              + b_fish_a  * Data.ite$fish4
                              + b_bio_a   * Data.ite$bio4
                              + b_coast_a * Data.ite$coast4
                              + b_lit_a   * Data.ite$lit4
                              + b_cost_a  * Data.ite$cost4
                              +              Data.ite$error4
       )
       
       Data.ite$utility5.cl1 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_a  * Data.ite$clar5 
                              + b_fish_a  * Data.ite$fish5
                              + b_bio_a   * Data.ite$bio5
                              + b_coast_a * Data.ite$coast5
                              + b_lit_a   * Data.ite$lit5
                              + b_cost_a  * Data.ite$cost5
                              +              Data.ite$error5
       )
       
       Data.ite$utility6.cl1 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_a  * Data.ite$clar6 
                              + b_fish_a  * Data.ite$fish6
                              + b_bio_a   * Data.ite$bio6
                              + b_coast_a * Data.ite$coast6
                              + b_lit_a   * Data.ite$lit6
                              + b_cost_a  * Data.ite$cost6
                              +              Data.ite$error6
       )
       ...
       Data.ite$utility1.cl2 <- (                                       # Creating utility 1 
                                   asc_1_b 
                                 + b_clar_b  * Data.ite$clar1 
                                 + b_fish_b  * Data.ite$fish1
                                 + b_bio_b   * Data.ite$bio1
                                 + b_coast_b * Data.ite$coast1
                                 + b_lit_b   * Data.ite$lit1
                                 + b_cost_b  * Data.ite$cost1
                                 +               Data.ite$error1
       )
       
       
       
       Data.ite$utility2.cl2 <- (                                       # Creating utility 2 
         # We assume asc = 0 for all the alternatives different from the SQ 
                                  b_clar_b  * Data.ite$clar2 
                                + b_fish_b  * Data.ite$fish2
                                + b_bio_b   * Data.ite$bio2
                                + b_coast_b * Data.ite$coast2
                                + b_lit_b   * Data.ite$lit2
                                + b_cost_b  * Data.ite$cost2
                                +              Data.ite$error2
       )
       
       
       Data.ite$utility3.cl2 <- (                                       # Creating utility 3  
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_b  * Data.ite$clar3 
                              + b_fish_b  * Data.ite$fish3
                              + b_bio_b   * Data.ite$bio3
                              + b_coast_b * Data.ite$coast3
                              + b_lit_b   * Data.ite$lit3
                              + b_cost_b  * Data.ite$cost3
                              +              Data.ite$error3
       )
       
       
       Data.ite$utility4.cl2 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_b  * Data.ite$clar4 
                              + b_fish_b  * Data.ite$fish4
                              + b_bio_b   * Data.ite$bio4
                              + b_coast_b * Data.ite$coast4
                              + b_lit_b   * Data.ite$lit4
                              + b_cost_b  * Data.ite$cost4
                              +              Data.ite$error4
       )
       
       Data.ite$utility5.cl2 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_b  * Data.ite$clar5 
                              + b_fish_b  * Data.ite$fish5
                              + b_bio_b   * Data.ite$bio5
                              + b_coast_b * Data.ite$coast5
                              + b_lit_b   * Data.ite$lit5
                              + b_cost_b  * Data.ite$cost5
                              +              Data.ite$error5
       )
       
       Data.ite$utility6.cl2 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_b  * Data.ite$clar6 
                              + b_fish_b  * Data.ite$fish6
                              + b_bio_b   * Data.ite$bio6
                              + b_coast_b * Data.ite$coast6
                              + b_lit_b   * Data.ite$lit6
                              + b_cost_b  * Data.ite$cost6
                              +              Data.ite$error6
       )
       
       ## CLASS 3
       
       Data.ite$utility1.cl3 <- (                                       # Creating utility 1 
                                   asc_1_c 
                                 + b_clar_c  * Data.ite$clar1 
                                 + b_fish_c  * Data.ite$fish1
                                 + b_bio_c   * Data.ite$bio1
                                 + b_coast_c * Data.ite$coast1
                                 + b_lit_c   * Data.ite$lit1
                                 + b_cost_c  * Data.ite$cost1
                                 +               Data.ite$error1
       )
       
       
       
       Data.ite$utility2.cl3 <- (                                       # Creating utility 2 
         # We assume asc = 0 for all the alternatives different from the SQ 
                                   b_clar_c  * Data.ite$clar2 
                                 + b_fish_c  * Data.ite$fish2
                                 + b_bio_c   * Data.ite$bio2
                                 + b_coast_c * Data.ite$coast2
                                 + b_lit_c   * Data.ite$lit2
                                 + b_cost_c  * Data.ite$cost2
                                 +              Data.ite$error2
       )
       
       
       Data.ite$utility3.cl3 <- (                                       # Creating utility 3  
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_c  * Data.ite$clar3 
                              + b_fish_c  * Data.ite$fish3
                              + b_bio_c   * Data.ite$bio3
                              + b_coast_c * Data.ite$coast3
                              + b_lit_c   * Data.ite$lit3
                              + b_cost_c  * Data.ite$cost3
                              +              Data.ite$error3
       )
       
       
       Data.ite$utility4.cl3 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_c  * Data.ite$clar4 
                              + b_fish_c  * Data.ite$fish4
                              + b_bio_c   * Data.ite$bio4
                              + b_coast_c * Data.ite$coast4
                              + b_lit_c   * Data.ite$lit4
                              + b_cost_c  * Data.ite$cost4
                              +              Data.ite$error4
       )
       
       Data.ite$utility5.cl3 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_c  * Data.ite$clar5 
                              + b_fish_c  * Data.ite$fish5
                              + b_bio_c   * Data.ite$bio5
                              + b_coast_c * Data.ite$coast5
                              + b_lit_c   * Data.ite$lit5
                              + b_cost_c  * Data.ite$cost5
                              +              Data.ite$error5
       )
       
       Data.ite$utility6.cl3 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                b_clar_c  * Data.ite$clar6 
                              + b_fish_c  * Data.ite$fish6
                              + b_bio_c   * Data.ite$bio6
                              + b_coast_c * Data.ite$coast6
                              + b_lit_c   * Data.ite$lit6
                              + b_cost_c  * Data.ite$cost6
                              +              Data.ite$error6
       )
       ...
       for (n in 1:(n.individuals*n.choices)) {
           if(Data.ite$Clase[n] == 1){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl1[n], Data.ite$utility2.cl1[n], Data.ite$utility3.cl1[n], Data.ite$utility4.cl1[n], Data.ite$utility5.cl1[n], Data.ite$utility6.cl1[n]))
           }
           if(Data.ite$Clase[n] == 2){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl2[n], Data.ite$utility2.cl2[n], Data.ite$utility3.cl2[n], Data.ite$utility4.cl2[n], Data.ite$utility5.cl2[n], Data.ite$utility6.cl2[n]))
           }
           if(Data.ite$Clase[n] == 3){
             Data.ite$choice[n]   <- which.max(c(Data.ite$utility1.cl3[n], Data.ite$utility2.cl3[n], Data.ite$utility3.cl3[n], Data.ite$utility4.cl3[n], Data.ite$utility5.cl3[n], Data.ite$utility6.cl3[n]))
           }
       }
...
write.table(Results, file="./Results_LCM_IC99_6Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
