...
for (ite in 1:NumIter){
       ...
       Data.ite$choice   <- apply(cbind(Data.ite$utility1, Data.ite$utility2, Data.ite$utility3, Data.ite$utility4), 1, which.max)    # Generating choice
       ...
       Data.ite$ch.clar <- ifelse(Data.ite$choice == 1, Data.ite$clar1,
                                  ifelse(Data.ite$choice == 2, Data.ite$clar2,
                                         ifelse(Data.ite$choice == 3, Data.ite$clar3,
                                                ifelse(Data.ite$choice == 4, Data.ite$clar4, NA))))
       ...
       Data.ite$ch.fish <- ifelse(Data.ite$choice == 1, Data.ite$fish1,
                                  ifelse(Data.ite$choice == 2, Data.ite$fish2,
                                         ifelse(Data.ite$choice == 3, Data.ite$fish3,
                                                ifelse(Data.ite$choice == 4, Data.ite$fish4, NA))))
       Data.ite$ch.bio  <- ifelse(Data.ite$choice == 1, Data.ite$bio1,
                                  ifelse(Data.ite$choice == 2, Data.ite$bio2,
                                         ifelse(Data.ite$choice == 3, Data.ite$bio3,
                                                ifelse(Data.ite$choice == 4, Data.ite$bio4, NA))))
       Data.ite$ch.coast<- ifelse(Data.ite$choice == 1, Data.ite$coast1,
                                  ifelse(Data.ite$choice == 2, Data.ite$coast2,
                                         ifelse(Data.ite$choice == 3, Data.ite$coast3,
                                                ifelse(Data.ite$choice == 4, Data.ite$coast4, NA))))
       Data.ite$ch.lit  <- ifelse(Data.ite$choice == 1, Data.ite$lit1,
                                  ifelse(Data.ite$choice == 2, Data.ite$lit2,
                                         ifelse(Data.ite$choice == 3, Data.ite$lit3,
                                                ifelse(Data.ite$choice == 4, Data.ite$lit4, NA))))
       Data.ite$ch.cost <- ifelse(Data.ite$choice == 1, Data.ite$cost1,
                                  ifelse(Data.ite$choice == 2, Data.ite$cost2,
                                         ifelse(Data.ite$choice == 3, Data.ite$cost3,
                                                ifelse(Data.ite$choice == 4, Data.ite$cost4, NA))))
       
       # Apply the function "min_no_cero" to identify the minimum value of cost different to cero in the alternatives, and to compare with the cost value of the chosen alternative.
       ...
       # Apply the function "max_no_cero" to identify the maximum value of cost different to cero in the alternatives, and to compare with the cost value of the chosen alternative.
...
weight <- rep(1/NumIter, NumIter)
resultS.SIMU<- data.frame(clar.chosen[,"Turbid_SQ"]            ,
                          clar.chosen[,"Rather turbid"]         ,     
                          clar.chosen[,"Rather clear"]  ,
                          clar.chosen[,"Clear"]         ,
                          fish.chosen[,"Overfished_SQ"] ,
                          fish.chosen[,"Stable"]        ,
                          bio.chosen[,"Bad_SQ"]       ,
                          bio.chosen[,"Rather bad"]   ,
                          bio.chosen[,"Rather good"]  ,
                          bio.chosen[,"Good"]         ,
                          coast.chosen[,"Strong impact_SQ"] ,
                          coast.chosen[,"Mainly low impact"],
                          lit.chosen[,"Very much_SQ"]    ,
                          lit.chosen[,"Much"]          ,
                          lit.chosen[,"Little"]        ,
                          lit.chosen[,"Very Little"]   ,
                          cost.chosen[,"0_SQ" ]    ,
                          cost.chosen[,"10"   ]   ,
                          cost.chosen[,"25"   ]  ,
                          cost.chosen[,"50"   ]  ,
...
p.clar.Turbid_SQ <- ggplot(resultS.SIMU, aes(clar.chosen[,"Turbid_SQ"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Clarity - Turbid_SQ", y="Frequency") + xlim(c((min(clar.obs[,"Turbid_SQ"], min(clar.chosen[,"Turbid_SQ"]))),max(clar.obs[,"Turbid_SQ"], max(clar.chosen[,"Turbid_SQ"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.clar[ "Turbid_SQ","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Turbid_SQ","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Turbid_SQ","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
...
p.clar.Rather_turbid <- ggplot(resultS.SIMU, aes(clar.chosen[,"Rather turbid"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Clarity - Rather turbid", y="Frequency") + xlim(c((min(clar.obs[,"Rather turbid"], min(clar.chosen[,"Rather turbid"]))),max(clar.obs[,"Rather turbid"], max(clar.chosen[,"Rather turbid"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.clar[ "Rather turbid","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Rather turbid","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Rather turbid","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.clar.Rather_clear <- ggplot(resultS.SIMU, aes(clar.chosen[,"Rather clear"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Clarity - Rather clear", y="Frequency") + xlim(c((min(clar.obs[,"Rather clear"], min(clar.chosen[,"Rather clear"]))),max(clar.obs[,"Rather clear"], max(clar.chosen[,"Rather clear"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.clar[ "Rather clear","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Rather clear","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Rather clear","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.clar.Clear <- ggplot(resultS.SIMU, aes(clar.chosen[,"Clear"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Clarity - Clear", y="Frequency") + xlim(c((min(clar.obs[,"Clear"], min(clar.chosen[,"Clear"]))),max(clar.obs[,"Clear"], max(clar.chosen[,"Clear"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.clar[ "Clear","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Clear","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.clar[ "Clear","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.fish.Overfished_SQ <- ggplot(resultS.SIMU, aes(fish.chosen[,"Overfished_SQ"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Fish - Overfished_SQ", y="Frequency") + xlim(c((min(fish.obs[,"Overfished_SQ"], min(fish.chosen[,"Overfished_SQ"]))),max(fish.obs[,"Overfished_SQ"], max(fish.chosen[,"Overfished_SQ"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.fish[ "Overfished_SQ","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.fish[ "Overfished_SQ","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.fish[ "Overfished_SQ","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.fish.Stable <- ggplot(resultS.SIMU, aes(fish.chosen[,"Stable"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Fish - Stable", y="Frequency") + xlim(c((min(fish.obs[,"Stable"], min(fish.chosen[,"Stable"]))),max(fish.obs[,"Stable"], max(fish.chosen[,"Stable"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.fish[ "Stable","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.fish[ "Stable","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.fish[ "Stable","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.bio.Bad_SQ <- ggplot(resultS.SIMU, aes(bio.chosen[,"Bad_SQ"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Biodiversity - Bad_SQ", y="Frequency") + xlim(c((min(bio.obs[,"Bad_SQ"], min(bio.chosen[,"Bad_SQ"]))),max(bio.obs[,"Bad_SQ"], max(bio.chosen[,"Bad_SQ"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.bio[ "Bad_SQ","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Bad_SQ","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Bad_SQ","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.bio.Rather_bad <- ggplot(resultS.SIMU, aes(bio.chosen[,"Rather bad"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Biodiversity - Rather bad", y="Frequency") + xlim(c((min(bio.obs[,"Rather bad"], min(bio.chosen[,"Rather bad"]))),max(bio.obs[,"Rather bad"], max(bio.chosen[,"Rather bad"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.bio[ "Rather bad","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Rather bad","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Rather bad","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.bio.Rather_good <- ggplot(resultS.SIMU, aes(bio.chosen[,"Rather good"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Biodiversity - Rather good", y="Frequency") + xlim(c((min(bio.obs[,"Rather good"], min(bio.chosen[,"Rather good"]))),max(bio.obs[,"Rather good"], max(bio.chosen[,"Rather good"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.bio[ "Rather good","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Rather good","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Rather good","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.bio.Good <- ggplot(resultS.SIMU, aes(bio.chosen[,"Good"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Biodiversity - Good", y="Frequency") + xlim(c((min(bio.obs[,"Good"], min(bio.chosen[,"Good"]))),max(bio.obs[,"Good"], max(bio.chosen[,"Good"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.bio[ "Good","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Good","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.bio[ "Good","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.coast.Strong_impact_SQ <- ggplot(resultS.SIMU, aes(coast.chosen[,"Strong impact_SQ"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Coastal - Strong impact_SQ", y="Frequency") + xlim(c((min(coast.obs[,"Strong impact_SQ"], min(coast.chosen[,"Strong impact_SQ"]))),max(coast.obs[,"Strong impact_SQ"], max(coast.chosen[,"Strong impact_SQ"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.coast[ "Strong impact_SQ","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.coast[ "Strong impact_SQ","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.coast[ "Strong impact_SQ","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.coast.Mainly_low_impact <- ggplot(resultS.SIMU, aes(coast.chosen[,"Mainly low impact"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Coastal - Mainly low impact", y="Frequency") + xlim(c((min(coast.obs[,"Mainly low impact"], min(coast.chosen[,"Mainly low impact"]))),max(coast.obs[,"Mainly low impact"], max(coast.chosen[,"Mainly low impact"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.coast[ "Mainly low impact","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.coast[ "Mainly low impact","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.coast[ "Mainly low impact","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.lit.Very_much_SQ <- ggplot(resultS.SIMU, aes(lit.chosen[,"Very much_SQ"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Lit - Very much_SQ", y="Frequency") + xlim(c((min(lit.obs[,"Very much_SQ"], min(lit.chosen[,"Very much_SQ"]))),max(lit.obs[,"Very much_SQ"], max(lit.chosen[,"Very much_SQ"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.lit[ "Very much_SQ","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Very much_SQ","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Very much_SQ","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.lit.Much <- ggplot(resultS.SIMU, aes(lit.chosen[,"Much"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Lit - Much", y="Frequency") + xlim(c((min(lit.obs[,"Much"], min(lit.chosen[,"Much"]))),max(lit.obs[,"Much"], max(lit.chosen[,"Much"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.lit[ "Much","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Much","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Much","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.lit.Little <- ggplot(resultS.SIMU, aes(lit.chosen[,"Little"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Lit - Little", y="Frequency") + xlim(c((min(lit.obs[,"Little"], min(lit.chosen[,"Little"]))),max(lit.obs[,"Little"], max(lit.chosen[,"Little"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.lit[ "Little","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Little","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Little","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.lit.Very_Little <- ggplot(resultS.SIMU, aes(lit.chosen[,"Very Little"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Lit - Very Little", y="Frequency") + xlim(c((min(lit.obs[,"Very Little"], min(lit.chosen[,"Very Little"]))),max(lit.obs[,"Very Little"], max(lit.chosen[,"Very Little"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.lit[ "Very Little","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Very Little","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.lit[ "Very Little","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.0_SQ <- ggplot(resultS.SIMU, aes(cost.chosen[,"0_SQ"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 0_SQ", y="Frequency") + xlim(c((min(cost.obs[,"0_SQ"], min(cost.chosen[,"0_SQ"]))),max(cost.obs[,"0_SQ"], max(cost.chosen[,"0_SQ"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "0_SQ","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "0_SQ","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "0_SQ","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.10 <- ggplot(resultS.SIMU, aes(cost.chosen[,"10"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 10", y="Frequency") + xlim(c((min(cost.obs[,"10"], min(cost.chosen[,"10"]))),max(cost.obs[,"10"], max(cost.chosen[,"10"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "10","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "10","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "10","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.25 <- ggplot(resultS.SIMU, aes(cost.chosen[,"25"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 25", y="Frequency") + xlim(c((min(cost.obs[,"25"], min(cost.chosen[,"25"]))),max(cost.obs[,"25"], max(cost.chosen[,"25"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "25","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "25","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "25","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.50 <- ggplot(resultS.SIMU, aes(cost.chosen[,"50"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 50", y="Frequency") + xlim(c((min(cost.obs[,"50"], min(cost.chosen[,"50"]))),max(cost.obs[,"50"], max(cost.chosen[,"50"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "50","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "50","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "50","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.80 <- ggplot(resultS.SIMU, aes(cost.chosen[,"80"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 80", y="Frequency") + xlim(c((min(cost.obs[,"80"], min(cost.chosen[,"80"]))),max(cost.obs[,"80"], max(cost.chosen[,"80"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "80","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "80","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "80","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.110 <- ggplot(resultS.SIMU, aes(cost.chosen[,"110"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 110", y="Frequency") + xlim(c((min(cost.obs[,"110"], min(cost.chosen[,"110"]))),max(cost.obs[,"110"], max(cost.chosen[,"110"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "110","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "110","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "110","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.160 <- ggplot(resultS.SIMU, aes(cost.chosen[,"160"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 160", y="Frequency") + xlim(c((min(cost.obs[,"160"], min(cost.chosen[,"160"]))),max(cost.obs[,"160"], max(cost.chosen[,"160"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "160","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "160","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "160","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.220 <- ggplot(resultS.SIMU, aes(cost.chosen[,"220"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 220", y="Frequency") + xlim(c((min(cost.obs[,"220"], min(cost.chosen[,"220"]))),max(cost.obs[,"220"], max(cost.chosen[,"220"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "220","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "220","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "220","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
p.cost.300 <- ggplot(resultS.SIMU, aes(cost.chosen[,"300"], weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Cost - 300", y="Frequency") + xlim(c((min(cost.obs[,"300"], min(cost.chosen[,"300"]))),max(cost.obs[,"300"], max(cost.chosen[,"300"])))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost[ "300","observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "300","0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost[ "300","99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
## MINIMUM COST NO-CERO

p.min.cost.NO.cero<- ggplot(resultS.SIMU, aes(lowest.cost.no0, weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Minimum cost no cero", y="Frequency") + xlim(c((min(lowest.cost.no0.obs, min(lowest.cost.no0))),max(lowest.cost.no0.obs, max(lowest.cost.no0)))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost.MIN.NOcero[ ,"observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost.MIN.NOcero[ ,"0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost.MIN.NOcero[ ,"99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
## MAXIMUM COST NO-CERO

p.max.cost.NO.cero<- ggplot(resultS.SIMU, aes(highest.cost.no0, weight = weight)) + geom_histogram(color="black", fill="white")+  
  labs(x="Maximum cost no cero", y="Frequency") + xlim(c((min(highest.cost.no0.obs, min(highest.cost.no0))),max(highest.cost.no0.obs, max(highest.cost.no0)))) + ylim(c(0,1))+
  geom_vline(xintercept = Results.cost.MAX.NOcero[ ,"observed"]        , linetype="dotted", color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost.MAX.NOcero[ ,"0.5% percentile"] , linetype="longdash",color = "black", size=1.5)+
  geom_vline(xintercept = Results.cost.MAX.NOcero[ ,"99.5% percentile"], linetype="longdash",color = "black", size=1.5)+ 
  theme_classic()+
  theme(text = element_text(size=25),
        plot.title = element_blank(),
        axis.title.x = element_blank(),
...
write.table(Results, file="./Results_MNL_IC99_4Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
