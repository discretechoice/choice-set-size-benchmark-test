...
for (ite in 1:NumIter){
       ...
       # Generate choice
       Data.ite$choice   <- apply(cbind(Data.ite$utility1, Data.ite$utility2), 1, which.max)    # Generating choice
...
write.table(Results, file="./Results_MNL_IC99_2Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
