...
####################################################################
#####
#####            RPL correlation, no socio-dem - 6 alternatives - treatment 5
...
for (ite in 1:NumIter){
       ...
       Data.ite$error6 <- rgumbel(n.individuals * n.choices ,loc=0, scale=1)
       ...
       Data.ite$utility6 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                Data.ite$rand.clar  * Data.ite$clar6 
                              + Data.ite$rand.fish  * Data.ite$fish6
                              + Data.ite$rand.bio   * Data.ite$bio6
                              + Data.ite$rand.coast * Data.ite$coast6
                              + Data.ite$rand.lit   * Data.ite$lit6
                              + Data.ite$rand.cost  * Data.ite$cost6
                              +                       Data.ite$error6
       )
...
write.table(Results, file="./Results_RPL_CostLogNormal_IC99_6Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
