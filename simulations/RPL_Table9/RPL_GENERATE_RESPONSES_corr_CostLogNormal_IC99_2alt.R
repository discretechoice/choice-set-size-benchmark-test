...
####################################################################
#####
#####            RPL correlation, no socio-dem - 2 alternatives - treatment 1
...
write.table(Results, file="./Results_RPL_CostLogNormal_IC99_2Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
