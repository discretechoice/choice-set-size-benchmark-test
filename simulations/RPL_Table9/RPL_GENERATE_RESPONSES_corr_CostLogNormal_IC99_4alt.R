...
####################################################################
#####
#####            RPL correlation, no socio-dem - 4 alternatives - treatment 3
...
write.table(Results, file="./Results_RPL_CostLogNormal_IC99_4Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
