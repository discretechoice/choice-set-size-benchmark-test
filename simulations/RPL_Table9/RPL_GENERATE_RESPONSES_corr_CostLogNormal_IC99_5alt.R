...
####################################################################
#####
#####            RPL correlation, no socio-dem - 5 alternatives - treatment 4
...
for (ite in 1:NumIter){
       ...
       Data.ite$error4 <- rgumbel(n.individuals * n.choices ,loc=0, scale=1)
       Data.ite$error5 <- rgumbel(n.individuals * n.choices ,loc=0, scale=1)
       ...
       Data.ite$utility4 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                Data.ite$rand.clar  * Data.ite$clar4 
                              + Data.ite$rand.fish  * Data.ite$fish4
                              + Data.ite$rand.bio   * Data.ite$bio4
                              + Data.ite$rand.coast * Data.ite$coast4
                              + Data.ite$rand.lit   * Data.ite$lit4
                              + Data.ite$rand.cost  * Data.ite$cost4
                              +                       Data.ite$error4
       )
       
       Data.ite$utility5 <- (                                       # Creating utility 4 
                                # We assume asc = 0 for all the alternatives different from the SQ 
                                Data.ite$rand.clar  * Data.ite$clar5 
                              + Data.ite$rand.fish  * Data.ite$fish5
                              + Data.ite$rand.bio   * Data.ite$bio5
                              + Data.ite$rand.coast * Data.ite$coast5
                              + Data.ite$rand.lit   * Data.ite$lit5
                              + Data.ite$rand.cost  * Data.ite$cost5
                              +                       Data.ite$error5
       )
       ...
       Data.ite$choice   <- apply(cbind(Data.ite$utility1, Data.ite$utility2, Data.ite$utility3, Data.ite$utility4, Data.ite$utility5), 1, which.max)    # Generating choice
...
write.table(Results, file="./Results_RPL_CostLogNormal_IC99_5Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
