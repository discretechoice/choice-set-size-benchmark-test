...
#####
#####            WTP calculations
#####            LCM - 5 alternatives - treatment 4
#####
####################################################################
####################################################################
...
UN_wtp_clar_d  <- -(UNcond.Cl.all.prob[["b_clar"]][[4]]/UNcond.Cl.all.prob[["b_cost"]][[4]])
...
UN_wtp_fish_d  <- -(UNcond.Cl.all.prob[["b_fish"]][[4]]/UNcond.Cl.all.prob[["b_cost"]][[4]])
...
UN_wtp_bio_d  <- -(UNcond.Cl.all.prob[["b_bio"]][[4]]/UNcond.Cl.all.prob[["b_cost"]][[4]])
...
UN_wtp_coast_d  <- -(UNcond.Cl.all.prob[["b_coast"]][[4]]/UNcond.Cl.all.prob[["b_cost"]][[4]])
...
UN_wtp_lit_d  <- -(UNcond.Cl.all.prob[["b_lit"]][[4]]/UNcond.Cl.all.prob[["b_cost"]][[4]])

summary(as.data.frame(UNcond.Cl.all.prob[["pi_values"]]))

LCM_UN_WTP.clar  <- UNcond.Cl.all.prob[["pi_values"]][[1]] * UN_wtp_clar_a   +  UNcond.Cl.all.prob[["pi_values"]][[2]] * UN_wtp_clar_b   +  UNcond.Cl.all.prob[["pi_values"]][[3]] * UN_wtp_clar_c   +  UNcond.Cl.all.prob[["pi_values"]][[4]] * UN_wtp_clar_d 
LCM_UN_WTP.fish  <- UNcond.Cl.all.prob[["pi_values"]][[1]] * UN_wtp_fish_a   +  UNcond.Cl.all.prob[["pi_values"]][[2]] * UN_wtp_fish_b   +  UNcond.Cl.all.prob[["pi_values"]][[3]] * UN_wtp_fish_c   +  UNcond.Cl.all.prob[["pi_values"]][[4]] * UN_wtp_fish_d 
LCM_UN_WTP.bio   <- UNcond.Cl.all.prob[["pi_values"]][[1]] * UN_wtp_bio_a    +  UNcond.Cl.all.prob[["pi_values"]][[2]] * UN_wtp_bio_b    +  UNcond.Cl.all.prob[["pi_values"]][[3]] * UN_wtp_bio_c    +  UNcond.Cl.all.prob[["pi_values"]][[4]] * UN_wtp_bio_d  
LCM_UN_WTP.coast <- UNcond.Cl.all.prob[["pi_values"]][[1]] * UN_wtp_coast_a  +  UNcond.Cl.all.prob[["pi_values"]][[2]] * UN_wtp_coast_b  +  UNcond.Cl.all.prob[["pi_values"]][[3]] * UN_wtp_coast_c  +  UNcond.Cl.all.prob[["pi_values"]][[4]] * UN_wtp_coast_d
LCM_UN_WTP.lit   <- UNcond.Cl.all.prob[["pi_values"]][[1]] * UN_wtp_lit_a    +  UNcond.Cl.all.prob[["pi_values"]][[2]] * UN_wtp_lit_b    +  UNcond.Cl.all.prob[["pi_values"]][[3]] * UN_wtp_lit_c    +  UNcond.Cl.all.prob[["pi_values"]][[4]] * UN_wtp_lit_d  
...
write.table(simu.WTP.Results, file="./simu_WTP_5Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
write.table(median_CI_WTP, file="./median_CI_WTP_5Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
