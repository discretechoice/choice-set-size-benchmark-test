...
#####
#####            WTP calculations
#####            LCM - 6 alternatives - treatment 5
#####
####################################################################
####################################################################
...
write.table(simu.WTP.Results, file="./simu_WTP_6Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
write.table(median_CI_WTP, file="./median_CI_WTP_6Alt.csv", sep=" ", row.names = TRUE, col.names=TRUE)
